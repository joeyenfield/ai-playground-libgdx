...
public class ShapeRenderUtilDrawer {
	float prog1 = 0;
	float prog2 = 0;
	float ang1 = 0;
	float ang2 = 0;
	...
	public boolean strictDraw = false;

	public void charBounds(ShapeDrawer render, Vector2 pos, float size) {
		render.filledRectangle(pos.x, pos.y, size, size);
	}

	public void render(ShapeDrawer render, CharSequence seq, Vector2 p, float size, Viewport viewport) {
		helper.getBounds(viewport,viewportBounds);
		render(render, seq,p,size,viewportBounds);
	}

	public void render(ShapeDrawer render, CharSequence seq, float x, float y, float size,Viewport viewport) {
		helper.getBounds(viewport,viewportBounds);
		render(render, seq,x,y,size,viewportBounds);
	}

	public void render(ShapeDrawer render, CharSequence seq, Vector2 p, float size, Rectangle viewport) {
		render(render, seq, p.x,p.y, size, viewport);
	}

	public void render(ShapeDrawer render, CharSequence seq, float x, float y, float size, Rectangle viewport) {
	...
	public void renderBounds(ShapeDrawer render, CharSequence seq, Vector2 pos, float size, Rectangle viewport) {
	...
	public void render(ShapeDrawer render, char c, Vector2 pos, float size, Rectangle viewport) {
		updateBounds(pos, size);
		if ((!strictDraw && !viewport.overlaps(currentBounds)) || (strictDraw && !viewport.contains(currentBounds))) {
...
//			System.out.println("\n");
	...
	public void num2(ShapeDrawer render) {
		float inset = 0.1f;
		float radius = 0.3f;
	...
	public void num3(ShapeDrawer render) {
		float inset = 0.2f;
		float radius = 0.31f;
	...
	public void num4(ShapeDrawer render) {
		float inset = 0.2f;
		float offsetX = -0.1f;
	...
	public void num5(ShapeDrawer render) {
		float radius = 0.33f;
	...
	public void num6(ShapeDrawer render) {
		float radius = 0.3f;
	...
	public void num9(ShapeDrawer render) {
		float radius = 0.3f;
	...
	public void aUpper(ShapeDrawer render) {
	...
	public void bUpper(ShapeDrawer render) {
	...
	public void eUpper(ShapeDrawer render) {
		float flatBit = 0.6f;
		float offset = 0.2f;
		// Side
		line(offset + bottomLineInset, 0, offset + bottomLineInset, 1, lineThickness, render);
	...
	public void fUpper(ShapeDrawer render) {
		float flatBit = 0.6f;
		float offset = 0.2f;
		// Side
		line(offset + bottomLineInset, 0, offset + bottomLineInset, 1, lineThickness, render);
	...
	public void gUpper(ShapeDrawer render) {
	...
	public void hUpper(ShapeDrawer render) {
		float offset = 0.2f;
	...
	public void iUpper(ShapeDrawer render) {
		float inset = 0.1f;
	...
	public void jUpper(ShapeDrawer render) {
		float inset = 0.1f;
		float rad = 0.25f;
	...
	public void kUpper(ShapeDrawer render) {
		float inset = 0.2f;
	...
	public void lUpper(ShapeDrawer render) {
		float flatBit = 0.6f;
		float offset = 0.2f;
		// Side
		line(offset + bottomLineInset, 0, offset + bottomLineInset, 1, lineThickness, render);
	...
	public void mUpper(ShapeDrawer render) {
		float inset = 0.1f;
	...
	public void nUpper(ShapeDrawer render) {
		float inset = 0.1f;
	...
	public void oUpper(ShapeDrawer render) {
		arcLine(0.5f, 0.5f, 0.5f - bottomLineInset, lineThickness, 0, 360, 20, render);
	};

	public void pUpper(ShapeDrawer render) {
		float topSize = 0.3f;
		float flatBit = 0.3f;
		float offset = 0.2f;
		// Side
	...
	public void qUpper(ShapeDrawer render) {
		arcLine(0.5f, 0.5f, 0.5f - bottomLineInset, lineThickness, 0, 360, 20, render);
		roundline(0.6f, 0.4f, topLineInset, bottomLineInset, lineThickness, render);
	};

	public void rUpper(ShapeDrawer render) {
		float topSize = 0.3f;
		float flatBit = 0.3f;
		float offset = 0.2f;
		// Side
	...
	public void sUpper(ShapeDrawer render) {
		float inset = 0.2f;
	...
	public void vUpper(ShapeDrawer render) {
	...
	public void wUpper(ShapeDrawer render) {
	...
	public void xUpper(ShapeDrawer render) {
	...
	public void yUpper(ShapeDrawer render) {
	...
	public void zUpper(ShapeDrawer render) {
		float inset = 0.1f;
	...
	public void colinUpper(ShapeDrawer render) {
		circle(0.5f, 0.75f, lineThickness, render);
		circle(0.5f, 0.25f, lineThickness, render);
	};

	public void question(ShapeDrawer render) {
	...
	public void circle(float x, float y, float radius, ShapeDrawer render) {
		x = currentPos.x + currentSize * x;
		y = currentPos.y + currentSize * y;
		render.filledCircle(x, y, radius * currentSize);
	}

	public void line(float x1, float y1, float x2, float y2, float thick, ShapeDrawer render) {
		x1 = currentPos.x + currentSize * x1;
		y1 = currentPos.y + currentSize * y1;

		x2 = currentPos.x + currentSize * x2;
		y2 = currentPos.y + currentSize * y2;
		render.line(x1, y1, x2, y2, thick * currentSize);
	}
	 ...
	 * @param render
	 */
	public void rect(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, ShapeDrawer render) {
		x1 = currentPos.x + currentSize * x1;
		y1 = currentPos.y + currentSize * y1;
		...
		render.filledTriangle(x1, y1, x2, y2, x3, y3);
		render.filledTriangle(x1, y1, x3, y3, x4, y4);
	}

	public void roundline(float x1, float y1, float x2, float y2, float thick, ShapeDrawer render) {
		if (!lowQuality) {
	...
	public void circleLine(float xCenter, float yCenter, float radius, float lineThick, int segments, ShapeDrawer render) {
		arcLine(xCenter, yCenter, radius, lineThick, 0, 360, segments, render);
	}

	public void arcLine(float xCenter, float yCenter, float radius, float lineThick, float startAngleDeg, float endAngleDeg, int segments, ShapeDrawer render) {
