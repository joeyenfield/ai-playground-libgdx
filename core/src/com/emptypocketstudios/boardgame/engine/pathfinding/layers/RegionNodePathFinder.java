...
public class RegionNodePathFinder {
    ...
    HashMap<RegionNode, RegionLinks> bestPath = new HashMap<>();
    ...
    protected PathFindingResultEnum findPath(World world, RegionNode startRegionNode, RegionNode targetRegionNode, Array<RegionNode> path) {
        ...
        while (openRegions.size() > 0) {
            ...
            for (int i = 0; i < chunkLinks.size; i++) {
                ...
                workOutWeight(currentLink, nextLink, targetRegionNode);
    ...
    protected void workOutWeight(RegionLinks parent, RegionLinks current, RegionNode target) {
